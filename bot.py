"""
╔══════════════════════════════════════════════════════════════╗
║         EVALON WINNERS — TELEGRAM SUPPORT BOT v6.9          ║
║                                                              ║
║  ✅ Multi-step menu                                          ║
...
def get_prize_text(prize_key, lang):
    ...
    lose_texts = {
        "almost_won": {
            "en": "🎯 *SO CLOSE! You almost won!*\n\n😮 The wheel stopped just one step away from a prize!\n\nKeep spinning daily — winners are chosen from the most active players! 🔥",
            "sw": "🎯 *KARIBU SANA! Ulikaribia kushinda!*\n\n😮 Gurudumu lilisimama hatua moja tu mbali na tuzo!\n\nEndelea kuspin kila siku — washindi huchaguliwa kutoka kwa wachezaji wanaoshiriki zaidi! 🔥",
            "ar": "🎯 *قريب جداً! كدت تفوز!*\n\n😮 توقف العجلة على بُعد خطوة واحدة من الجائزة!\n\nاستمر في الدوران يومياً — يتم اختيار الفائزين من اللاعبين الأكثر نشاطاً! 🔥",
            "zh": "🎯 *非常接近！差点赢了！*\n\n😮 转盘停在离奖品只有一步之遥的地方！\n\n每天持续旋转——获胜者从最活跃的玩家中选出！ 🔥",
            "ru": "🎯 *ТАК БЛИЗКО! Почти выиграли!*\n\n😮 Колесо остановилось в одном шаге от приза!\n\nПродолжайте крутить ежедневно — победителей выбирают из самых активных! 🔥",
            "hi": "🎯 *बहुत करीब! लगभग जीत गए!*\n\n😮 पहिया पुरस्कार से एक कदम दूर रुका!\n\nहर रोज spin करते रहें — सबसे सक्रिय खिलाड़ियों में से विजेता चुने जाते हैं! 🔥",
            "es": "🎯 *¡MUY CERCA! ¡Casi ganaste!*\n\n😮 ¡La rueda se detuvo a un paso del premio!\n\n¡Sigue girando diariamente — los ganadores se eligen entre los más activos! 🔥",
            "fr": "🎯 *TELLEMENT PROCHE! Presque gagné!*\n\n😮 La roue s'est arrêtée à un pas du prix!\n\nContinuez à tourner quotidiennement — les gagnants sont choisis parmi les plus actifs! 🔥",
            "pt": "🎯 *TÃO PERTO! Quase ganhou!*\n\n😮 A roda parou a um passo do prêmio!\n\nContinue girando diariamente — os vencedores são escolhidos entre os mais ativos! 🔥",
            "de": "🎯 *SO NAH! Fast gewonnen!*\n\n😮 Das Rad blieb einen Schritt vom Preis entfernt stehen!\n\nDrehen Sie täglich weiter — Gewinner werden unter den Aktivsten ausgewählt! 🔥",
            "ur": "🎯 *بہت قریب! تقریباً جیت گئے!*\n\n😮 پہیہ انعام سے صرف ایک قدم دور رکا!\n\nروزانہ spin کرتے رہیں — سب سے زیادہ فعال کھلاڑیوں میں سے فاتح چنے جاتے ہیں! 🔥",
            "ja": "🎯 *惜しい！もう少しで当選！*\n\n😮 ホイールが賞品まであと一歩のところで止まりました！\n\n毎日回し続けてください — 最もアクティブなプレイヤーから勝者が選ばれます！ 🔥",
        },
        "try_again": {
            "en": "🔄 *Not this time!*\n\n💪 But don't give up — the more you spin, the better your chances!\n\nActive daily spinners get noticed and rewarded by our team! 🏆",
            "sw": "🔄 *Si wakati huu!*\n\n💪 Lakini usikate tamaa — unavyospin zaidi, ndivyo nafasi yako inavyoongezeka!\n\nWanaospin kila siku wanaonekana na timu yetu na hupewa zawadi! 🏆",
            "ar": "🔄 *ليس هذه المرة!*\n\n💪 لكن لا تستسلم — كلما دورت أكثر، كلما زادت فرصك!\n\nيلاحظ فريقنا اللاعبين النشطين يومياً ويكافئهم! 🏆",
            "zh": "🔄 *这次不行！*\n\n💪 但不要放弃——旋转越多，机会越大！\n\n每天活跃的玩家会被我们的团队注意并奖励！ 🏆",
            "ru": "🔄 *Не в этот раз!*\n\n💪 Но не сдавайтесь — чем больше крутите, тем лучше шансы!\n\nАктивные игроки замечаются нашей командой и вознаграждаются! 🏆",
            "hi": "🔄 *इस बार नहीं!*\n\n💪 लेकिन हार मत मानिए — जितना अधिक spin करें, उतने बेहतर chances!\n\nरोज active spinners को हमारी team notice करती है और reward देती है! 🏆",
            "es": "🔄 *¡Esta vez no!*\n\n💪 ¡Pero no te rindas — cuanto más gires, mejores tus posibilidades!\n\n¡Los que giran activamente a diario son notados y recompensados por nuestro equipo! 🏆",
            "fr": "🔄 *Pas cette fois!*\n\n💪 Mais ne abandonnez pas — plus vous tournez, meilleures sont vos chances!\n\nLes joueurs actifs quotidiens sont remarqués et récompensés par notre équipe! 🏆",
            "pt": "🔄 *Não desta vez!*\n\n💪 Mas não desista — quanto mais girar, melhores suas chances!\n\nOs que giram ativamente diariamente são notados e recompensados pela nossa equipe! 🏆",
            "de": "🔄 *Nicht dieses Mal!*\n\n💪 Aber geben Sie nicht auf — je mehr Sie drehen, desto besser Ihre Chancen!\n\nAktive tägliche Dreher werden von unserem Team bemerkt und belohnt! 🏆",
            "ur": "🔄 *اس بار نہیں!*\n\n💪 لیکن ہمت نہ ہاریں — جتنا زیادہ spin کریں، اتنا بہتر موقع!\n\nروزانہ فعال spinners کو ہماری ٹیم notice کرتی ہے اور انعام دیتی ہے! 🏆",
            "ja": "🔄 *今回は残念！*\n\n💪 でも諦めないで — 回せば回すほどチャンスが増えます！\n\n毎日アクティブにスピンする人はチームに注目されて報酬を受けます！ 🏆",
        },
        "better_luck": {
            "en": "💪 *Better luck tomorrow!*\n\n🌟 Every spin counts — our team tracks the most loyal players!\n\nCome back tomorrow and keep your streak alive! 🔥",
            "sw": "💪 *Bahati njema kesho!*\n\n🌟 Kila spin inahesabiwa — timu yetu inafuatilia wachezaji waaminifu zaidi!\n\nRudi kesho na endelea kuwa mstari! 🔥",
            "ar": "💪 *حظ أوفر غداً!*\n\n🌟 كل دورة تحتسب — فريقنا يتتبع اللاعبين الأكثر ولاءً!\n\nعد غداً وحافظ على سلسلتك! 🔥",
            "zh": "💪 *明天好运！*\n\n🌟 每次旋转都很重要——我们的团队追踪最忠实的玩家！\n\n明天回来保持连胜！ 🔥",
            "ru": "💪 *Больше удачи завтра!*\n\n🌟 Каждый спин важен — наша команда отслеживает самых преданных игроков!\n\nВернитесь завтра и сохраните серию! 🔥",
            "hi": "💪 *कल बेहतर किस्मत!*\n\n🌟 हर spin मायने रखती है — हमारी team सबसे loyal players को track करती है!\n\nकल वापस आएं और streak बनाए रखें! 🔥",
            "es": "💪 *¡Mejor suerte mañana!*\n\n🌟 ¡Cada giro cuenta — nuestro equipo rastrea a los jugadores más leales!\n\n¡Vuelve mañana y mantén tu racha! 🔥",
            "fr": "💪 *Meilleure chance demain!*\n\n🌟 Chaque tour compte — notre équipe suit les joueurs les plus fidèles!\n\nRevenez demain et maintenez votre série! 🔥",
            "pt": "💪 *Melhor sorte amanhã!*\n\n🌟 Cada giro conta — nossa equipe rastreia os jogadores mais leais!\n\nVolte amanhã e mantenha sua sequência! 🔥",
            "de": "💪 *Mehr Glück morgen!*\n\n🌟 Jedes Drehen zählt — unser Team verfolgt die treuesten Spieler!\n\nKommen Sie morgen zurück und halten Sie Ihre Serie aufrecht! 🔥",
            "ur": "💪 *کل زیادہ قسمت!*\n\n🌟 ہر spin اہمیت رکھتی ہے — ہماری ٹیم سب سے وفادار کھلاڑیوں کو track کرتی ہے!\n\nکل واپس آئیں اور streak برقرار رکھیں! 🔥",
            "ja": "💪 *明日は幸運を！*\n\n🌟 毎回のスピンが重要です — チームが最も忠実なプレイヤーを追跡します！\n\n明日戻ってきてストリークを維持してください！ 🔥",
        },
    }
...
BOT_LAUNCH_DATE = datetime(2026, 5, 19)  # update this to your actual launch date

def get_active_traders_count():
    """
    Grow from 30,009 to ~100,000 over 90 days.
    After 100k: fluctuate between 145,100 and 145,900.
    Within each day: small hourly variations for realism.
    """
    now = datetime.now()
    days_elapsed = (now - BOT_LAUNCH_DATE).days
    hour = now.hour
    minute = now.minute
    ...
    if days_elapsed <= 90:
        # Linear growth: 30009 → 100000 over 90 days
        # ~778 new traders per day
        daily_growth = 778
        base = 30009 + (days_elapsed * daily_growth)
        # Hourly variation: ±50 within the day (busier midday)
        hour_factor = int(20 * (hour / 24.0) * (1 - hour / 24.0) * 4)
        count = base + hour_factor
        count = min(count, 100000)
    else:
        # Fluctuate between 145,100 and 145,900
        # Use hour+minute as seed for smooth realistic changes
        seed = days_elapsed * 100 + hour
        rng = random.Random(seed)
        base = rng.randint(145100, 145900)
        # Small minute-based micro-variation
        micro = (minute % 10) * 8
        count = base + micro
        count = max(145100, min(145900, count))

    return f"{count:,}"

def get_online_now():
    """
    Online Now: starts ~346, varies by hour realistically.
    Busier during market hours (8am-10pm), quieter at night.
    """
    now = datetime.now()
    hour = now.hour
    minute = now.minute
    day_seed = now.timetuple().tm_yday + now.year + hour

    rng = random.Random(day_seed)

    # Base by time of day
    if 0 <= hour < 6:      # Night — quiet
        base = rng.randint(80, 180)
    elif 6 <= hour < 9:    # Early morning
        base = rng.randint(200, 350)
    elif 9 <= hour < 12:   # Morning peak
        base = rng.randint(346, 520)
    elif 12 <= hour < 15:  # Midday
        base = rng.randint(400, 680)
    elif 15 <= hour < 18:  # Afternoon peak
        base = rng.randint(480, 750)
    elif 18 <= hour < 21:  # Evening peak
        base = rng.randint(520, 820)
    elif 21 <= hour < 24:  # Late evening
        base = rng.randint(300, 500)
    else:
        base = 346

    # Minute micro-variation ±15
    micro = random.Random(day_seed + minute).randint(-15, 15)
    return max(50, base + micro)

def build_welcome_text(lang, name):
    """Build full welcome text with community vibe counter"""
    urgency = get_urgency(lang)
    traders = get_active_traders_count()
    online  = get_online_now()

    vibe_lines = {
        "en": f"👥 *{traders}* active traders today  |  🟢 *{online}* online now",
        "sw": f"👥 Wafanyabiashara *{traders}* leo  |  🟢 *{online}* wako online sasa",
        "ar": f"👥 *{traders}* متداول نشط اليوم  |  🟢 *{online}* متصل الآن",
        "zh": f"👥 今日 *{traders}* 活跃交易者  |  🟢 *{online}* 正在线上",
        "hi": f"👥 आज *{traders}* सक्रिय ट्रेडर  |  🟢 *{online}* अभी ऑनलाइन",
        "ru": f"👥 *{traders}* активных сегодня  |  🟢 *{online}* онлайн сейчас",
        "es": f"👥 *{traders}* traders activos hoy  |  🟢 *{online}* en línea ahora",
        "fr": f"👥 *{traders}* traders actifs aujourd'hui  |  🟢 *{online}* en ligne",
        "pt": f"👥 *{traders}* traders ativos hoje  |  🟢 *{online}* online agora",
        "de": f"👥 *{traders}* aktive Trader heute  |  🟢 *{online}* jetzt online",
        "ur": f"👥 آج *{traders}* فعال ٹریڈرز  |  🟢 ابھی *{online}* آن لائن",
        "ja": f"👥 今日 *{traders}* 人のトレーダー  |  🟢 今 *{online}* 人オンライン",
    }
    vibe = vibe_lines.get(lang, vibe_lines["en"])
            ...
            if ref_count in milestones:
                ...
                try:
                    await context.bot.send_message(
                        ...
                        protect_content=True,
                        reply_markup=InlineKeyboardMarkup([[
                            InlineKeyboardButton("💬 Redeem Discount", callback_data="do_support")
                        ]]))
                except:
                    pass
                # Also notify admin
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main_menu":
        ...
        # MSG 3 — Total count + persuasion (protected)
        persuasion_texts = {
            "en": (
                f"📊 *Your Referral Score: {ref_count} people invited*\n\n"
                f"{'🎉 You have reached the minimum! Claim your discount by contacting support!' if ref_count >= REFERRAL_MIN else f'🎯 Invite just {needed} more to unlock your first reward!'}\n\n"
                f"💡 *Why invite more?*\n"
                f"• 5 invited → 5% discount\n"
                f"• 10 invited → 10% discount\n"
                f"• 20 invited → 20% discount\n"
                f"• 50 invited → 50% discount\n"
                f"• 100 invited → 70% discount 🔥\n\n"
                f"🚀 Share your link above — every person you invite earns YOU more!"
            ),
            "sw": (
                f"📊 *Alama Yako ya Rufaa: watu {ref_count} wamealikwa*\n\n"
                f"{'🎉 Umefika kiwango cha chini! Dai punguzo lako kwa kuwasiliana na support!' if ref_count >= REFERRAL_MIN else f'🎯 Alika {needed} zaidi tu kufungua tuzo yako ya kwanza!'}\n\n"
                f"💡 *Kwa nini uendelee kuwa kuita?*\n"
                f"• Watu 5 → Punguzo 5%\n"
                f"• Watu 10 → Punguzo 10%\n"
                f"• Watu 20 → Punguzo 20%\n"
                f"• Watu 50 → Punguzo 50%\n"
                f"• Watu 100 → Punguzo 70% 🔥\n\n"
                f"🚀 Shiriki kiungo chako hapo juu — kila mtu unayemwalika unakupata ZAIDI!"
            ),
            "ar": (
                f"📊 *نقاط الإحالة: {ref_count} شخص مدعو*\n\n"
                f"{'🎉 وصلت إلى الحد الأدنى! اطلب خصمك بالتواصل مع الدعم!' if ref_count >= REFERRAL_MIN else f'🎯 ادعُ {needed} فقط لفتح مكافأتك الأولى!'}\n\n"
                f"💡 *لماذا تدعو المزيد؟*\n"
                f"• 5 أشخاص → خصم 5%\n"
                f"• 100 شخص → خصم 70% 🔥\n\n"
                f"🚀 شارك رابطك أعلاه!"
            ...
            "ru": (
                f"📊 *Ваш счёт: {ref_count} приглашённых*\n\n"
                f"{'🎉 Вы достигли минимума! Получите скидку через поддержку!' if ref_count >= REFERRAL_MIN else f'🎯 Пригласите ещё {needed} для первой награды!'}\n\n"
                f"💡 *Почему приглашать больше?*\n"
                f"• 5 человек → скидка 5%\n"
                f"• 100 человек → скидка 70% 🔥\n\n"
                f"🚀 Поделитесь своей ссылкой выше!"
            ),
        }
        ...
        try:
            p_msg = await send_protected_text(
                ...
                InlineKeyboardMarkup([
                    [InlineKeyboardButton("💬 Claim Discount", callback_data="do_support")],
                    [InlineKeyboardButton(ui("btn_back", lang), callback_data="main_menu")],
                ]))
    ...
    # ── TODAY'S VIP RESULTS ────────────────────────────────────
        ...
        back_kb = InlineKeyboardMarkup([
            [InlineKeyboardButton("📲 Join VIP Channel", url=MAIN_CHANNEL_LINK)],
            [InlineKeyboardButton(ui("btn_back", lang), callback_data="main_menu")]
        ])
        if not content:
